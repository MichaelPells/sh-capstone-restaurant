    ...
    return (
        <div>
            <div className="Foreview">
               <br/><br/>
               <div align="center">
                    <img src="/sh-capstone-restaurant/img/logo.png" alt="SOLLY KINGS" style={{width: '60%', display: 'block', margin: '0px'}}/>
                    <br/>
                    ...
                    <br/><br/>
                    <CTA text={"Buy a Meal"} url={"/sh-capstone-restaurant/products"} padding={'10px'} />
                    <br/><br/><br/><br/>

                    <div className="Content" style={{width: '70%'}}>
                        <form action="/sh-capstone-restaurant/contact" method="get" style={{width: '70%', color: '#ffffff'}}>
                            <div align="left">
                            <br/>
